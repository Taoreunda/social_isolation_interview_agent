...
function withSessionErrors(api: AppApi, authorizedRequest: AuthorizedRequest): AppApi {
  return {
    ...
    listStaff: () => authorizedRequest(() => api.listStaff()),
    createStaff: (input) => authorizedRequest(() => api.createStaff(input)),
    changeStaffRole: (staffId, role) => authorizedRequest(() => api.changeStaffRole(staffId, role)),
    resetStaffPassword: (staffId) => authorizedRequest(() => api.resetStaffPassword(staffId)),
    disableStaff: (staffId) => authorizedRequest(() => api.disableStaff(staffId)),
    enableStaff: (staffId) => authorizedRequest(() => api.enableStaff(staffId)),
    unlockStaff: (staffId) => authorizedRequest(() => api.unlockStaff(staffId)),
