...
## value 기입 규칙
- value는 참여자의 문장이 아니라 짧은 코드값입니다 (12자 이내).
- 예/아니요 문항(A1, D1, D2): "예" 또는 "아니요"
- 횟수 문항(A2): "주 0회", "주 3회"
- 인원 문항(B1, C1): "0명", "2명"
- 기간 문항(A3, B2, C2, D1_duration, D2_duration): "3개월", "1년"
- 점수 문항: "7점"
- 참여자의 표현이나 판단 근거는 value가 아니라 rationale에 적습니다.
- E1/E2만 참여자의 말을 그대로 value에 담습니다.
